...
class OrderRepository {
  ...
  async getByMeja(mejaNum) {
    try {
      // In a real app we'd filter on backend, but here we can just filter all
      const orders = await this.getAll();
      return orders.filter(o => String(o.meja) === String(mejaNum));
    } catch (e) {
      console.error(e);
      return [];
    }
...
// ============================================================
// ENCAPSULATION — MenuRepository (API Backend)
// ============================================================
